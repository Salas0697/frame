...
The legacy `interaction-v1.js` rule `scroll-behavior:smooth` also animated direct scrollLeft writes; it is removed at its source so alignment is truly immediate.
